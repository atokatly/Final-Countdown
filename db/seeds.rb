...
Preference.create(rank:2, student_id: 1, pitch_id: 1, round_id:2)
Preference.create(rank:1, student_id: 1, pitch_id: 2, round_id:2)
Preference.create(rank:1, student_id: 2, pitch_id: 2, round_id:2)
Preference.create(rank:2, student_id: 2, pitch_id: 1, round_id:2)
Preference.create(rank:1, student_id: 3, pitch_id: 1, round_id:2)
Preference.create(rank:2, student_id: 3, pitch_id: 2, round_id:2)
